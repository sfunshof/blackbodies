<div>
    @once('navbar-styles')
        @include('livewire.navbar.cssblade.navbar-styles')
    @endonce
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-3 d-flex">
                    ...
                    <!-- Previous Button -->
                    <button wire:click="showPrev" @if($total <= 1 || $currentIndex <= 0) hiddenx @endif 
                        class="nav-btn prev-btn" type="button" id="prevButton">
                ...
                <div class="col-3 d-flex justify-content-end">
                    <button wire:click="showNext" @if($total <= 1 || $currentIndex >= $total - 1) hiddenx @endif 
